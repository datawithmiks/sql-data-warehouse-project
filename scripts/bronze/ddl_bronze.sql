...
=============================================================================
*/
-- Create 6 bronze tables, name their source, and the exact csv file name

-- Check if the table exists, then drop it once it exists
...
-- I accidentally mismatched the data types of the first column
-- Newbie issues hehe
